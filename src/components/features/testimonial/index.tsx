...
const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => (
    <div className="bg-white dark:bg-gray-800/50 rounded-xl shadow-sm border border-border-light dark:border-border-dark p-6 text-white">
  ...
  return (
      <div className="container mx-auto px-6 py-16" id="depoimentos">
        <h2 className="text-3xl font-bold mb-8 flex items-center text-gray-800 dark:text-white ">
          Depoimentos
          <span className="ml-3 bg-blue-900 text-white dark: px-3 py-1 rounded-full text-sm">
            {totalCount}
          </span>
        </h2>
