...
export default function ChoosePathScreen() {
  ...
  function handleClickOcto() {
    router.push('/exclusive-content');
  }

  function handleClickDuo() {
    router.push('/journey');
  }
      ...
      <div className="w-full flex flex-col items-center justify-start h-screen max-w-lg mx-auto bg-white py-6">
        ...
        <main className="h-full flex justify-center flex-col">
          ...
          <section className="flex flex-col gap-4">
            ...
            <div onClick={handleClickDuo} className="flex flex-col items-center  justify-center p-8 border-2 border-gray-200 rounded-xl space-y-2 hover:border-cyan-500 cursor-pointer transition-all duration-400 ease-in hover:scale-101">
            ...
            <div onClick={handleClickOcto} className="flex flex-col items-center  justify-center p-6 px-2 border-2 border-gray-200 rounded-xl space-y-2 hover:border-octor-400 cursor-pointer transition-all duration-400 ease-in hover:scale-101">
